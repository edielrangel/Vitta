...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Dicionário de Termos</li>
        </ol>
        {{-- <div class="card mb-4">
            <div class="card-body">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-2"><a class="btn btn-primary btn-sm" href="{{ route('dicionario.create') }}" role="button">
                    <i class="fas fa-plus"></i> Adicionar Termo</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($termos as $termo)
                                <tr>
                                    ...
                                    <td>{{ $termo->termo }}</td>
                                    <td>
                                        <form action="{{ route('dicionario.destroy', $termo->id) }}" method="post">
                                            {{csrf_field()}}
                                            {{method_field('delete')}}
                                            <a class="btn btn-warning btn-sm" href="{{ route('dicionario.edit', $termo->id) }}" role="button">
