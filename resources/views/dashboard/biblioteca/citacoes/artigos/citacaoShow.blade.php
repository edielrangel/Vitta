    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                Citações do Artigo: {{ $citacao->titulo }}
            </div>
            <div class="card-body">
                {{ $citacao->citacao }}
            </div>
        ...
        <div class="card mb-4">
            ...
            <form id="delete-editora-{{ $citacao->id }}" action="{{ route('citacaoArtigo.destroy', $citacao->id) }}" method="post">
                {{csrf_field()}}
                {{method_field('delete')}}
                <a class="btn btn-success" href="{{ route('citacaoArtigo.edit', $citacao->id) }}" role="button">
                    <i class="fas fa-pen mr-1"></i>Editar</a>
        
                <a class="btn btn-warning" href="{{ route('citacaoArtigo.show', $citacao->artigo_id) }}" role="button">
