...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Editar Resenha</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                <i class="fas fa-plus mr-1"></i>
                Editar dados da Resenha
            </div>
            <div class="card-body">
                <div class="col-12">
                    @if ($errors->any())
                ...
                <div class="col-12">
                    <form action="{{ route('resenhas.update', $resenha->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label>Livro</label>
                                <input type="text" class="form-control" name="livro" value="{{ $resenha->titulo }}" readonly>
                                <input type="hidden" name="livro_id" value="{{ $resenha->livro_id }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label>Resenha</label>
                                <textarea name="resenha" class="form-control" cols="30" rows="20">{{ $resenha->resenha ?? old('resenha') }}</textarea>
                            </div>
                        </div>
